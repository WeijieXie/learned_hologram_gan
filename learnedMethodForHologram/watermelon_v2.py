...
from .neural_network_components import (
    UNet_imgDepth2AP_deprecated_v2,
    UNet_imgDepth2AP_heavyweight_deprecated_v2,
    ResNet_POH,
)
...
class watermelon_v2(nn.Module):
    def __init__(
        ...
        if heavyweight_UNet:
            self.part1 = UNet_imgDepth2AP_heavyweight_deprecated_v2(output_channels=6).to(self.device)
        else:
            self.part1 = UNet_imgDepth2AP_deprecated_v2(output_channels=6).to(self.device)
